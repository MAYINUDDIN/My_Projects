...
const DailybusinessDetails = () => {
    ...
    //             const name = loadedData.OFF_NAME;
    //             console.log(name);
    //             console.log(loadedData);
    //             const ekokScData = loadedData.map(ekok => {
    //                 const div_name = ekok.OFF_NAME;
    //                 const first_year = ekok.TOTAL_1ST_YR;
    //                 const t_ren = ekok.TOTAL_RENEWAL;
    //                 const total = ekok.TOTAL;
    //                 <h3>{div_name}</h3>

    //                 console.log(div_name, first_year, t_ren, total);
    //                 // const partss = ekok.OFF_NAME;
    ...
    return (
        <div>
            ...
            <div className="col-md-12 shadow p-1">
                <button style={{ fontSize: '16px' }} className='btn rounded mb-2 btn-success drop-shadow-lg bg-[#087f23] btn-md text-white m-1'><b>DAILY BUSINESS REPORT <span className='text-fareast text-[#ffea00] text-lg'>From: {from} To: {to}</span>  </b></button>
